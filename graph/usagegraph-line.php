...
$data['Y1']['options'] = array("SetLegend" =>"Hourly Clicks", "SetColor" => "orange");
$data['Y1']['addtype'] = "AddY2";
...
$options= array("SetScale" => "textlin", "SetY2Scale" => "lin");
$margin = array(33,34,25,25);
